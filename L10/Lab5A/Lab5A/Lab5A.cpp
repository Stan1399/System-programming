...
//	Сначала запускается часть B, потом А. При флажке drawable и нажатии на экран B отрисовывается фигура.
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	CreateWindow(L"button", L"Красный",
		...
		10, 10, 150, 30, hWnd, (HMENU)RBUTTON11_ID, hInstance, NULL);
	CreateWindow(L"button", L"Зелёный",
		WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
		10, 35, 150, 30, hWnd, (HMENU)RBUTTON12_ID, hInstance, NULL);
	CreateWindow(L"button", L"Синий",
		WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
		10, 60, 150, 30, hWnd, (HMENU)RBUTTON13_ID, hInstance, NULL);

	CreateWindow(L"button", L"Ромб",
		WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
		200, 10, 150, 30, hWnd, (HMENU)RBUTTON21_ID, hInstance, NULL);
	CreateWindow(L"button", L"Прямоугольник",
		WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
		200, 35, 150, 30, hWnd, (HMENU)RBUTTON22_ID, hInstance, NULL);
	CreateWindow(L"button", L"Круг",
		WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
		200, 60, 150, 30, hWnd, (HMENU)RBUTTON23_ID, hInstance, NULL);
	CreateWindow(L"button", L"Звезда",
		WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
		200, 85, 150, 30, hWnd, (HMENU)RBUTTON24_ID, hInstance, NULL);

	CheckRadioButton(hWnd, RBUTTON11_ID, RBUTTON13_ID, RBUTTON11_ID);
	CheckRadioButton(hWnd, RBUTTON21_ID, RBUTTON24_ID, RBUTTON21_ID);

	CreateWindow(L"button", L"Отобразить",
		WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
		10, 150, 100, 30, hWnd, (HMENU)CHECKBOX_ID, hInstance, NULL);
