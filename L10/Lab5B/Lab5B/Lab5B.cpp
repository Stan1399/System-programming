...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	bmp = LoadImage(NULL, L"Star.bmp", IMAGE_BITMAP, 100, 100, LR_LOADFROMFILE);
			...
			if (message == WM_SHAPE) {
				...
				case WM_PAINT:
					...
					if (draw && drawX != -1) {
						...
						case 0:
						{
							POINT p[4] = { drawX + 40, drawY + 0, drawX + 80, drawY + 20,
								drawX + 40, drawY + 40, drawX + 0, drawY + 20 };
							Polygon(hdc, p, 4);
						}
						break;
						case 1:
							Rectangle(hdc, drawX, drawY, drawX + 100, drawY + 150);
							break;
						case 2:
							Ellipse(hdc, drawX, drawY, drawX + 100, drawY + 150);
							break;
						case 3:
						{
							HDC hCompatibleDC;
							hCompatibleDC = CreateCompatibleDC(hdc);
							SelectObject(hCompatibleDC, bmp);
							/*if (reverse)
								StretchBlt(hdc, drawX, drawY, 100, 100, hCompatibleDC, 100, 0, -100, 100, SRCCOPY);
							else*/
								StretchBlt(hdc, drawX, drawY, 100, 100, hCompatibleDC, 0, 0, 100, 100, SRCCOPY);
