// L11.cpp : Defines the entry point for the application.
//
...
DWORD WINAPI MoveCircle(ThreadArgs *args) {
	while (true) {
		...
		args->y = tan((double)(args->time) / 100) * 100 + 150;
		Sleep(20);
	}
	return 0;
}
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	hWnd = CreateWindow(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
		CW_USEDEFAULT, 0, 1900, 900, NULL, NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		if (args1.y != 0)
		{
			...
			Rectangle(hdc, args1.x, args1.y, args1.x + 60, args1.y + 120);
			Rectangle(hdc, args2.x, args2.y, args2.x + 120, args2.y + 60);
		}
		EndPaint(hWnd, &ps);
		break;
	case WM_DESTROY:
