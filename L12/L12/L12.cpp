// L12.cpp : Defines the entry point for the application.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		hf = CreateFontW(800, 0, 0, 0, 0, TRUE, 0, 0, 0, 0, 0, 0, 0, L"Times New Roman");
		SelectObject(hdc, hf);
		SetTextColor(hdc, RGB(204, 234, 153));
		TextOutW(hdc, 20, 20, CharToLPWSTR(str), strlen(str));
		EndPaint(hWnd, &ps);
	}
	break;
	case WM_DESTROY:
